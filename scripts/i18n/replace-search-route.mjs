...
/**
 * 替换 search.tsx 文件的脚本
 * 将修复后的 search-fixed.tsx 内容替换到 search.tsx
 */
...
const BACKUP_FILE = path.join(SRC_ROUTES, 'search-backup.tsx');
const TARGET_FILE = path.join(SRC_ROUTES, 'search.tsx');
const FIXED_FILE = path.join(SRC_ROUTES, 'search-fixed.tsx');
...
try {
  ...
  console.log('✅ Successfully replaced search.tsx with fixed version');

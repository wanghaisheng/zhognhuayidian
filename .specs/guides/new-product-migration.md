...
1.  **Execute Keyword Research Protocol**:
    *   Open `specs/growth/keyword-research-protocol.md`.
...
2.  **Structure and Refactor**:
    *   **Analyze the AI Output**: Break down the generated JSX into logical pieces (Atoms, Molecules, Organisms) as defined in `specs/protocols/component-architecture.md`.

...
export const ADMIN_NAV_ITEMS = [
  ...
  { key: 'articles', path: '/admin/articles', iconName: 'FileText' },
  { key: 'devices', path: '/admin/devices', iconName: 'Stethoscope' },
...
export const SEO_DEFAULTS = {
  ...
  openGraph: {
    ...
    site_name: 'China CT Scanner',
    images: [
      {
        url: 'https://chinactscanner.org/og-image.jpg',
        width: 1200,
        height: 630,
        alt: 'China CT Scanner',
      },
    ],
  },
  twitter: {
    handle: '@chinactscanner',
    site: '@chinactscanner',
    cardType: 'summary_large_image',
  },
  defaultImage: 'https://chinactscanner.org/og-image.jpg',
  defaultLocale: 'en_US',
  twitterCard: 'summary_large_image' as const,
  robots: 'index, follow',
  twitterSite: '@chinactscanner',
  twitterCreator: '@chinactscanner',
};
